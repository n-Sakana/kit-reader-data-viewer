...
public static class Rdv3Text
{
    ...
    public const string BusinessDefinitionMismatch = "統合台帳作成時と入力形式・結合・保存・削除の定義が違います。同じ統合台帳への書込みはできません。作成時の設定へ戻すか、別の統合台帳を指定してください。";
    public const string ProtectionInvalid = "統合台帳の定義または削除保管データが不正です。書込みを停止しました。正常な控えから統合台帳を復旧してください。";
    public const string ArchiveIdentityConflict = "復元対象が変更されたか、同じ識別キーが既に統合台帳にあります。上書きせず停止しました。統合台帳を読み直して確認してください。";
    ...
    public const string RestoreConfirm = "選択した {0} 件を、削除時の内容と確認状態で統合台帳へ復元します。よろしいですか。";
    public const string DeleteStateHint = "\u78BA\u8A8D\u72B6\u614B\u306F\u7D71\u5408\u53F0\u5E33\u306B\u4FDD\u5B58\u6E08\u307F\u306E\u5024\u3067\u5224\u5B9A\u3057\u307E\u3059\u3002\u672A\u9001\u4FE1\u306E\u5909\u66F4\u306F\u9001\u4FE1\u3057\u3066\u304B\u3089\u524A\u9664\u3057\u3066\u304F\u3060\u3055\u3044\u3002";
    ...
    public const string InputWarningSummary = "\u540C\u3058\u30AD\u30FC\u306E\u884C\u304C {n} \u884C\u3042\u3063\u305F\u305F\u3081\u9664\u5916\u3057\u307E\u3057\u305F\u3002\u8A73\u3057\u304F\u306F\u64CD\u4F5C\u30ED\u30B0\u3092\u898B\u3066\u304F\u3060\u3055\u3044\u3002";
    ...
    public const string FileMatchExact = "完全一致";
    ...
    public const string DataNoDerivedColumn = "\u7D50\u5408\u3057\u305F\u7D50\u679C\u306B\u5217 {name} \u304C\u3042\u308A\u307E\u305B\u3093\uFF08{where}\uFF09\u3002\u5165\u529B\u306E\u898B\u51FA\u3057\u304B\u3001\u8A08\u7B97\u5217\u3067\u4F5C\u3063\u305F\u5217\u540D\u3092\u6307\u5B9A\u3057\u3066\u304F\u3060\u3055\u3044\u3002";
    public const string LedgerColumnNotProduced = "\u7D71\u5408\u53F0\u5E33\u306B\u6B8B\u3059\u5217 {name} \u304C\u7D50\u5408\u3057\u305F\u7D50\u679C\u306B\u3042\u308A\u307E\u305B\u3093\u3002\u305D\u306E\u5217\u306E\u8868\u3092\u3064\u306A\u3044\u3067\u3044\u306A\u3044\u304B\u3001\u7DB4\u308A\u304C\u9055\u3044\u307E\u3059\u3002";
    ...
    public const string StorageContractMismatch = "\u3053\u306E\u7D71\u5408\u53F0\u5E33\u3068\u8A2D\u5B9A\u306E\u5217\u30FB\u8B58\u5225\u30AD\u30FC\u30FB\u4F5C\u696D\u72B6\u614B\u306E\u5B9A\u7FA9\u304C\u4E00\u81F4\u3057\u307E\u305B\u3093\u3002\u540C\u3058\u7D71\u5408\u53F0\u5E33\u3092\u4F7F\u3046\u5168PC\u306E\u5B9A\u7FA9\u3092\u78BA\u8A8D\u3057\u3066\u304F\u3060\u3055\u3044\u3002";

    public const string UpdateChangedDuringCheck = "\u78BA\u8A8D\u4E2D\u306B\u7D71\u5408\u53F0\u5E33\u306E\u5185\u5BB9\u304C\u5909\u308F\u308A\u307E\u3057\u305F\u3002\u4E0A\u66F8\u304D\u305B\u305A\u4E2D\u6B62\u3057\u307E\u3057\u305F\u3002\u3082\u3046\u4E00\u5EA6\u300C\u66F4\u65B0\u300D\u3067\u78BA\u8A8D\u3057\u3066\u304F\u3060\u3055\u3044\u3002";
    ...
    public const string DiscardPendingConfirm = "\u3053\u306E\u4E00\u89A7\u306E\u672A\u9001\u4FE1\u5909\u66F4\u3092\u7834\u68C4\u3057\u307E\u3059\u304B\uFF1F \u7D71\u5408\u53F0\u5E33\u306E\u5185\u5BB9\u306F\u5909\u66F4\u3057\u307E\u305B\u3093\u3002\u5FC5\u8981\u306A\u5909\u66F4\u306F\u3001\u6700\u65B0\u306E\u5185\u5BB9\u3092\u78BA\u8A8D\u3057\u3066\u304B\u3089\u767B\u9332\u3057\u76F4\u3057\u3066\u304F\u3060\u3055\u3044\u3002";
    public const string DiscardPendingButton = "\u4e00\u89a7\u306e\u672a\u9001\u4fe1\u5909\u66f4\u3092\u7834\u68c4";
    public const string LedgerStateInvalid = "\u7D71\u5408\u53F0\u5E33\u306B\u8A2D\u5B9A\u3067\u5B9A\u7FA9\u3055\u308C\u3066\u3044\u306A\u3044\u4F5C\u696D\u72B6\u614B\u304C\u3042\u308A\u307E\u3059\u3002\u884C ";
    public const string ExportExists = "\u540c\u540d\u30d5\u30a1\u30a4\u30eb\u3078\u306e\u4e0a\u66f8\u304d\u306f\u884c\u3044\u307e\u305b\u3093\u3002\u5225\u306e\u30d5\u30a1\u30a4\u30eb\u540d\u3092\u6307\u5b9a\u3057\u3066\u304f\u3060\u3055\u3044\u3002";
    public const string ExportProtected = "\u5165\u529B\u30FB\u7D71\u5408\u53F0\u5E33\u30FB\u8A2D\u5B9A\u30FB\u30D7\u30ED\u30B0\u30E9\u30E0\u95A2\u9023\u306E\u30D5\u30A1\u30A4\u30EB\u306B\u306F\u51FA\u529B\u3067\u304D\u307E\u305B\u3093\u3002";
    public const string ExportCsvOnly = "\u51fa\u529b\u5148\u306b\u306f .csv \u30d5\u30a1\u30a4\u30eb\u3092\u6307\u5b9a\u3057\u3066\u304f\u3060\u3055\u3044\u3002";
    public const string StaleLedger = "\u8868\u793A\u306F\u66F4\u65B0\u524D\u306E\u7D71\u5408\u53F0\u5E33\u3067\u3059\u3002\u300C\u66F4\u65B0\u300D\u3067\u6700\u65B0\u306E\u7D71\u5408\u53F0\u5E33\u3092\u78BA\u8A8D\u3057\u3066\u304F\u3060\u3055\u3044\u3002";
    ...
    public const string StateApplying = "\u7D71\u5408\u53F0\u5E33\u3092\u66F4\u65B0\u4E2D";
    public const string StateDeleting = "\u30EC\u30B3\u30FC\u30C9\u3092\u524A\u9664\u4E2D";
    public const string StateSending = "\u9001\u4FE1\u4E2D";
    public const string StateReloading = "\u7D71\u5408\u53F0\u5E33\u3092\u8AAD\u307F\u76F4\u3057\u4E2D";
    public const string StateLockWaiting = "\u7D71\u5408\u53F0\u5E33\u304C\u7A7A\u304F\u306E\u3092\u5F85\u6A5F\u4E2D";
    public const string StateReady = "\u76E3\u8996\u4E2D";
    public const string StateSavingFmt = "{state}\u3092\u4FDD\u5B58\u4E2D";
    public const string StateBlocked = "\u7D71\u5408\u53F0\u5E33\u304C\u3042\u308A\u307E\u305B\u3093";
    ...
    public const string NoteNoDiff = "CSV\u30D5\u30A1\u30A4\u30EB\u3092\u8AAD\u307F\u8FBC\u307F\u307E\u3057\u305F\u3002\u7D71\u5408\u53F0\u5E33\u306E\u66F4\u65B0\u306F\u3042\u308A\u307E\u305B\u3093";
    public const string NoteUpdated = "\u7D71\u5408\u53F0\u5E33\u3092\u66F4\u65B0\u3057\u307E\u3057\u305F";
    public const string NoteRejected = "\u66F4\u65B0\u3092\u898B\u9001\u308A\u307E\u3057\u305F (\u4FDD\u5B58\u6E08\u307F\u7D71\u5408\u53F0\u5E33\u306E\u307E\u307E)";
    ...
    public const string LedgerCreateTitle = "統合台帳の作成";
    public const string LedgerUpdateTitle = "統合台帳の更新";
    public const string LedgerCreatedFmt = "統合台帳を作成しました。\n統合台帳の件数 {rows} 件（追加 {added} 件）";
    public const string LedgerUpdatedFmt = "統合台帳を更新しました。\n統合台帳の件数 {rows} 件（追加 {added} 件、更新 {updated} 件、削除 {deleted} 件）";
    ...
    public const string ConfirmSendBody = "{n} 件の確認状態を統合台帳に書き込みます。よろしいですか？";
    ...
    public const string ErrNoLedgerNoSource = "統合台帳がありません。統合台帳を作るには、{files} を {dir} に置いて「データ更新」を押してください。";
    ...
    public const string NoteSourceMissing = "CSVが見つかりません: {files}（統合台帳はそのまま）";
    public const string ErrSourceMissing = "CSVファイルが見つかりません:\n{files}\n{dir} に置いてから「データ更新」を押してください。統合台帳は更新していません。";
    public const string ErrSourceError = "格納されているCSVファイルが指定外の形式です。統合台帳は更新していません。\n\n{reason}";
    ...
    public const string ErrCheckTimeout = "\u66F4\u65B0\u78BA\u8A8D\u304C\u30BF\u30A4\u30E0\u30A2\u30A6\u30C8\u3057\u307E\u3057\u305F (\u4FDD\u5B58\u6E08\u307F\u7D71\u5408\u53F0\u5E33\u306E\u307E\u307E\u7D9A\u884C\u3057\u307E\u3059)";
    public const string ErrPersist = "\u7D71\u5408\u53F0\u5E33\u3092\u66F8\u304D\u8FBC\u3081\u307E\u305B\u3093\u3067\u3057\u305F: ";
    public const string ErrLedgerRead = "\u7D71\u5408\u53F0\u5E33\u3092\u8AAD\u307F\u8FBC\u3081\u307E\u305B\u3093\u3067\u3057\u305F: ";
    ...
    public const string ErrUnknownState = "\u7D71\u5408\u53F0\u5E33\u306E\u72B6\u614B {stored} \u306F\u753B\u9762\u5B9A\u7FA9\u306B\u3042\u308A\u307E\u305B\u3093\u3002\u9077\u79FB\u3067\u304D\u307E\u305B\u3093";
    ...
    public const string ErrDataDir = "\u30C7\u30FC\u30BF\u30D5\u30A9\u30EB\u30C0\u304C\u898B\u3064\u304B\u308A\u307E\u305B\u3093: ";
    ...
    public const string ErrSendOverdue = "\u9001\u4FE1\u304C\u9577\u5F15\u3044\u3066\u3044\u307E\u3059\u3002\u7D71\u5408\u53F0\u5E33\u304C\u7A7A\u304F\u307E\u3067\u5F85\u3063\u3066\u3044\u307E\u3059";
    public const string ErrSharedWriteOverdue = "\u7D71\u5408\u53F0\u5E33\u306E\u66F8\u304D\u8FBC\u307F\u304C\u9577\u5F15\u3044\u3066\u3044\u307E\u3059\u3002\u7D50\u679C\u304C\u78BA\u5B9A\u3059\u308B\u307E\u3067\u5F85\u3063\u3066\u3044\u307E\u3059";
    public const string ErrReloadOverdue = "\u7D71\u5408\u53F0\u5E33\u306E\u8AAD\u307F\u76F4\u3057\u304C\u9577\u5F15\u3044\u3066\u3044\u307E\u3059";
    public const string ErrSharedMarker = "\u7D71\u5408\u53F0\u5E33\u306E\u66F4\u65B0\u901A\u77E5\u3092\u8AAD\u3081\u307E\u305B\u3093\u3067\u3057\u305F: ";
    public const string ErrSharedReload = "\u66F4\u65B0\u3055\u308C\u305F\u7D71\u5408\u53F0\u5E33\u3092\u8AAD\u307F\u76F4\u305B\u307E\u305B\u3093\u3067\u3057\u305F: ";
    public const string LockWaitingFmt = "{user}\uFF08{host}\uFF09\u304C {minutes} \u5206\u524D\u304B\u3089\u7D71\u5408\u53F0\u5E33\u3092\u4F7F\u7528\u3057\u3066\u3044\u307E\u3059\u3002\u7A7A\u304F\u307E\u3067\u5F85\u3061\u307E\u3059\u3002";
    ...
    public const string DataLedgerHeader = "{file} \u306E\u898B\u51FA\u3057\u884C\u304C\u3001\u4F5C\u696D\u72B6\u614B\u306E\u5217\u3068\u753B\u9762\u5B9A\u7FA9\u306E\u7D71\u5408\u53F0\u5E33\u5217\u306B\u4E00\u81F4\u3057\u307E\u305B\u3093";
    ...
    public const string DataLedgerDupIdentity = "{file}: {name} \u306E\u5024 {key} \u304C {row1} \u884C\u76EE\u3068 {row2} \u884C\u76EE\u306B\u3042\u308A\u307E\u3059 (\u7D71\u5408\u53F0\u5E33\u306E 1 \u884C\u306F {name} \u3067\u7279\u5B9A\u3057\u307E\u3059)";
    ...
    public const string SharedUpdateTitle = "\u7D71\u5408\u53F0\u5E33\u306E\u66F4\u65B0";
    public const string SharedUpdateBody = "\u7D71\u5408\u53F0\u5E33\u304C\u66F4\u65B0\u3055\u308C\u307E\u3057\u305F\u3002\u5207\u308A\u66FF\u3048\u307E\u3059\u304B";
    public const string SharedResetFmt = "\u4E2D\u8EAB\u304C\u5909\u308F\u3063\u305F\u305F\u3081{state}\u306B\u623B\u3063\u305F\u30EC\u30B3\u30FC\u30C9: {n} \u4EF6";
    public const string UnmatchedTitle = "\u9001\u4FE1\u3067\u304D\u306A\u304B\u3063\u305F\u30EC\u30B3\u30FC\u30C9";
    public const string UnmatchedBodyFmt = "\u7D71\u5408\u53F0\u5E33\u3078\u5F53\u3066\u3089\u308C\u306A\u304B\u3063\u305F\u5909\u66F4\u304C {n} \u4EF6\u3042\u308A\u307E\u3059\u3002\u672A\u9001\u4FE1\u306E\u307E\u307E\u6B8B\u3057\u307E\u3057\u305F\u3002";
    ...
    public const string UpdateRecordsHint = "\u30C7\u30FC\u30BF\u30D5\u30A9\u30EB\u30C0\u306E\u30D5\u30A1\u30A4\u30EB\u3092\u8AAD\u307F\u3001\u7D71\u5408\u53F0\u5E33\u3092\u66F4\u65B0\u3057\u307E\u3059\u3002";
    ...
    // ---- the business block at the top of settings.json (member names) ----
    public const string BizRoot = "業務設定";
    public const string BizFiles = "入力ファイル";
    public const string BizFileName = "ファイル名";
    public const string BizFileMatch = "一致";
    public const string BizMatchExact = "完全一致";
    public const string BizMatchPrefix = "前方一致";
    public const string BizKey = "キー列";
    public const string BizExtract = "計算列";
    public const string BizExtractColumn = "列名";
    public const string BizExtractExpr = "式";
    public const string BizJoins = "結合";
    public const string BizJoinLeft = "左";
    public const string BizJoinRight = "右";
    public const string BizJoinKeep = "残す行";
    public const string BizKeepBoth = "一致する行のみ";
    public const string BizKeepLeft = "左の全行";
    public const string BizKeepAll = "両方全部";
    public const string BizPaid = "支払済の判定条件";
    public const string BizCondColumn = "列";
    public const string BizCondValue = "値";
    public const string BizIdentity = "台帳のキー列";
    public const string BizSearch = "検索対象の列";
    public const string BizExtraColumns = "台帳の追加列";
    public const string BizDelete = "削除の照合条件";
    public const string BizDeleteFile = "ファイル";
    public const string BizDeleteKeys = "一致させる列";
    public const string BizDeleteLedger = "台帳の列";
    public const string BizDeleteSide = "削除用の列";
    public const string BizScreen = "画面";
    public const string BizSearchLabel = "検索欄のラベル";
    public const string BizUserBox = "左上の枠";
    public const string BizAppBox = "右上の枠";
    public const string BizRemarks = "文章枠1";
    public const string BizPlan = "文章枠2";
    public const string BizUsage = "文章枠3";
    public const string BizBoxName = "見出し";
    public const string BizRows = "行";
    public const string BizLabel = "ラベル";
    public const string BizColumn = "列";
    public const string BizDateFrom = "CSVの日付";
    public const string BizDateTo = "画面の日付";
    public const string BizJudgment = "決済状況の帯";
    ...
    // ---- what these members used to be called ------------------------------
    // The block is read by the names above only. A file written for the older
    // names is answered with the name it carries now, not with a spelling
    // complaint about a member nobody recognises.
    public const string BizWasExtract = "切り出し";
    public const string BizWasJoins = "つなぎ方";
    public const string BizWasKeepBoth = "両方にある行";
    public const string BizWasKeepLeft = "左は全部";
    public const string BizWasPaid = "支払済の条件";
    public const string BizWasIdentity = "台帳の1件を決める列";
    public const string BizWasSearch = "検索に使う列";
    public const string BizWasExtraColumns = "台帳に追加で残す列";
    public const string BizWasDelete = "削除の条件";
    public const string BizWasColumnNames = "台帳と帳票の列名";
    public const string BizWasKey = "識別する列";
    public const string BizWasMatchExact = "全部一致";
    public const string BizWasBoxName = "枠の名前";
    public const string CfgWasPaths = "場所";
    public const string CfgWasWatch = "読み取り元";
    public const string BizWasUserBox = "利用者情報";
    public const string BizWasAppBox = "受付情報";
    public const string BizWasRemarks = "意見欄";
    public const string BizWasPlan = "変更後の計画";
    public const string BizWasUsage = "利用状態";
    public const string BizWasJudgment = "決済状況";
    public const string BizRenamedFmt = "「{old}」は「{new}」に変わりました。";
    public const string BizRemovedFmt = "「{old}」は無くなりました。台帳の見出しと帳票の項目名は「表の名前.列名」をそのまま使います。";

    public const string BizJoined = "照合結果";
    public const string BizJudgeColumn = "決済確認済";
    public const string BizPaidStored = "支払済";
    public const string BizCondPrefix = "条件";
    public const string BizPaidRows = "支払済の行";
    public const string BizUpdateJob = "台帳の更新";
    public const string BizUpdateJobName = "取引・決済・受付を照合して統合台帳を更新";
    public const string BizDeleteJob = "確認済の削除";
    public const string BizDeleteJobName = "手続完了かつ確認済の案件を削除";
    public const string BizLedgerLabel = "統合台帳";
    public const string BizMatchedPrefix = "削除に一致する行";
    public const string BizProcessedRows = "確認済の行";
    public const string BizTargetRows = "削除対象";
    public const string BizWorkLabel = "確認状態";
    public const string BizJudgeUndefined = "要確認";
    public const string BizJudgeError = "判定エラー";
    public const string BizDefaultSearchLabel = "識別番号／受付番号";
    // ---- what the business block gets wrong, in its own words ----
    public const string BizConflict = "業務設定 があるときは data と screen は書きません（業務設定から作ります）。どちらか一方にしてください。";
    public const string BizNoFiles = "業務設定.入力ファイル に表が 1 つもありません。";
    public const string BizRefForm = "列は「表.列名」の形で書きます（例: 決済.オーダーID）。実際の値: 「{ref}」";
    public const string BizUnknownTable = "表「{table}」が 業務設定.入力ファイル にありません。入力ファイルに書いた名前（{tables}）のどれかにしてください。";
    public const string BizExtractForm = "計算列 は「列名」と「式」を持つ要素の配列で書きます。";
    public const string BizExtractNameTable = "計算列の列名にテーブル名は書きません: {name}";
    public const string BizExtractName = "計算列の列名に空白は使えません。実際: 「{name}」";
    public const string BizExtractNoTable = "計算列「{name}」の式が入力の列を 1 つも読んでいません。どの表の列なのかが決まりません。";
    public const string BizExtractTables = "計算列「{name}」の式が読む表が 1 つに決まりません（{tables}）。式は 1 つの表の列だけを使います。";
    public const string BizExtractDuplicate = "計算列 の「{name}」が 2 回あります。";
    public const string BizNoJoins = "業務設定.結合 が空です。少なくとも取引と決済をつなぐ 1 行が要ります。";
    public const string BizJoinLeftNotJoined = "結合[{n}] の左「{ref}」の表「{table}」は、それより前の行でつながれていません。左は 1 行目の左の表か、既につないだ表の列にしてください。";
    public const string BizJoinRightAgain = "結合[{n}] の右の表「{table}」は既につながれています。1 つの表は 1 回だけつなげます。";
    public const string BizJoinRightIsLeft = "結合[{n}] の右の表「{table}」は左側の表です。右にはまだつないでいない表を書きます。";
    public const string BizKeepWord = "残す行 は「{both}」「{left}」「{all}」のどれかです。実際: 「{value}」";
    public const string BizMatchWord = "一致 は「{exact}」か「{prefix}」です。実際: 「{value}」";
    public const string BizNotJoinedTable = "{where} の「{ref}」の表「{table}」は 結合 でつながれていません。台帳に入るのは、結合でつないだ表の列だけです。";
    public const string BizNoConditions = "業務設定.支払済の判定条件 が空です。支払済にする条件を 1 つ以上書いてください。";
    public const string BizNoIdentity = "業務設定.台帳のキー列 が空です。";
    public const string BizNoSearch = "業務設定.検索対象の列 が空です。";
    public const string BizDeleteFileUnknown = "削除の照合条件.ファイル「{table}」が 業務設定.入力ファイル にありません。";
    public const string BizDeleteFileJoined = "削除の照合条件.ファイル「{table}」は 結合 でつながれた表です。削除用の一覧は、つないでいない表にしてください。";
    public const string BizDeleteSideTable = "削除の照合条件.一致させる列[{n}].削除用の列「{ref}」は表「{table}」の列にしてください。";
    public const string BizDeleteNoKeys = "削除の照合条件.一致させる列 が空です。";
    public const string BizExtractUnusedTable = "計算列「{name}」の表「{table}」は 結合 にも 削除の照合条件 にもありません。";
    ...
    public const string BizExportUnknown = "帳票出力の初期項目 の「{ref}」は台帳に残る列ではありません（画面・候補一覧・識別・検索対象の列か「確認状態」）。";
    ...
    public const string BizPathKey = "業務設定.入力ファイル.{table}.キー列";
    public const string BizPathIdentity = "業務設定.台帳のキー列";
    public const string BizPathSearch = "業務設定.検索対象の列";
    ...
    public const string CfgPaths = "保存先";
    ...
    public const string CfgWatch = "監視対象";
    ...
    public const string SettingsStepColumnHint = " \u5217\u306F\u300C\u8868\u306E\u540D\u524D.\u5217\u540D\u300D\u3067\u66F8\u304D\u307E\u3059\u3002\u5165\u529B\u306E\u5217\u306F CSV \u306E\u898B\u51FA\u3057\u3069\u304A\u308A\u3001\u4F5C\u3063\u305F\u5217\u306F\u8A08\u7B97\u5217\u3067\u4ED8\u3051\u305F\u540D\u524D\u3067\u3059\u3002\u3053\u306E\u624B\u9806\u3088\u308A\u524D\u306E\u624B\u9806\u3067\u4F5C\u3089\u308C\u3066\u3044\u306A\u3044\u5217\u306F\u4F7F\u3048\u307E\u305B\u3093\u3002";
    ...
    public const string SettingsSearchNotSaved = "data.ledger.search.columns の「{name}」が data.ledger.columns.source にありません。検索対象の列は、保存する列（columns.source）にも並べてください。";
    ...
    public const string LedgerRowColumns = "統合台帳の {0} 行目の列数が違います。必要 {1} 列、実際 {2} 列。";
    ...
    public const string ProcessLedgerKey = "\u66F8\u304D\u8FBC\u307F\u5148\u306E\u30AD\u30FC\u304C\u7D71\u5408\u53F0\u5E33\u306E\u8B58\u5225\u5217\u3068\u9055\u3044\u307E\u3059\u3002\u8A2D\u5B9A\u306E\u5BFE\u8C612\u3092\u7D71\u5408\u53F0\u5E33\u306E\u8B58\u5225\u5217\u306B\u5408\u308F\u305B\u3066\u304F\u3060\u3055\u3044\u3002";
    public const string LedgerLengths = "統合台帳の内容行数と作業状態の行数が一致しません。統合台帳の整合性を確認してください。";
    public const string LedgerNotUpdate = "レコード更新のジョブが指定されていません。";
    public const string LedgerNoResult = "更新ジョブの結果が統合台帳ではありません。最後の出力を確認してください。";
    public const string LedgerNoWrite = "更新ジョブに統合台帳へ書き込む手順がありません。";
    ...
    public const string LedgerNoDeleteResult = "削除ジョブの結果が統合台帳ではありません。最後の出力を確認してください。";
    public const string LedgerBlankRow = "{0} の {1} 行目の識別列が空です。統合台帳の処理を停止しました。";
    public const string LedgerDuplicateRows = "{0} の識別値「{1}」が {2} 行目と {3} 行目で重複しています。統合台帳の処理を停止しました。";
    ...
    public const string XlsxLedgerExtra = "{0}: 統合台帳のセル {1} に未定義の列の値「{2}」があります。";
    public const string XlsxLedgerNoHead = "{0}: 統合台帳に見出し行がありません。";
    ...
    public const string XlsxLedgerSheets = "統合台帳には LEDGER シートだけを置いてください。追加のシートは別のブックへ保存してください。";
    ...
    public const string XlsxInvalidDimensions = "統合台帳の行数・列数・作業状態の件数が不正です。行は 1048575 件、内容列は 16383 列までで、状態は各行に1つ必要です。";
    public const string XlsxNullRow = "統合台帳の {0} 行目の内容が存在しません。";
